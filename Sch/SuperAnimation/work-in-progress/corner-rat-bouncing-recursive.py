...
# Draw initial stuff
slow = Cnv.create_rectangle(0, 0, 100, 100, fill="white")
internal = Cnv.create_rectangle(0, 0, 25, 25, fill="grey")
wall = Cnv.create_rectangle(W/2-4, 0, W/2+4, 100, fill="grey")
...
def animate():
    ...
    Cnv.move(internal, vx_internal+vx_slow, vy_internal+vy_slow)
